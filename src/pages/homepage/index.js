    ...
    <Card >
      <CardContent>
        ...
        <Typography color="textSecondary" gutterBottom>
          Coach: {program.creator.firstName + ' ' + program.creator.lastName}
        </Typography>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Votre demande de participation au programme "{program.name}" a été envoyée au coach {program.creator.firstName + ' ' + program.creator.lastName}.
